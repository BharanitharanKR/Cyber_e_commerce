  ...
  return (
    <div className="relative bg-blackGradient w-full h-[400px] flex justify-center items-center text-white overflow-hidden">
      ...
      <div className="absolute top-0 left-2  translate-x-4">
        <img className="w-[200px] h-[200px] z-30" src={ipad} />
      </div>
      <div className="absolute z-10  top-0 left-12  translate-x-4">
        <img className="w-[200px] h-[200px] translate-x-36 translate-z-24" src={image6} />
      </div>
      ...
      <div className="absolute bottom-0 left-0 ">
        <img className="w-[300px] h-[300px]" src={phone} />
      </div>
      ...
      <div className="text-center px-6">
       ...
       <Link to="/deals"> <button className="w-[191px] h-[56px] bg-red-600 text-white rounded-lg hover:bg-red-700 transition-all"></Link>
          Shop Now
        </button>
      </div>
    </div>
