...
import { Drawer, List, ListItem, FormControlLabel, Checkbox, Divider, Typography } from "@mui/material";
...
const Sidebar = () => {
  return (
    <Drawer variant="permanent" className="sidebar">
      <List>
        <Typography variant="h6" className="sidebar-title">Filters</Typography>
        <Divider />
        <ListItem>
