...
const ProductPage = () => {
  return (
    ...
    const images = [img1, img2, img3, img4]; // Add more if needed

    <div className="container mx-auto pl-16 pr-16 flex gap-6">
      {/* Left Side: Image Section */}
      <div className="w-1/2 flex flex-col items-center">
  <img src={images[0]} alt="Product" className="w-full object-contain" />
  ...
  <div className="flex items-center gap-2 mt-4">
    ...
    <button className="w-8 h-8 rounded-full bg-red-500 text-white">→</button>
  </div>
</div>
