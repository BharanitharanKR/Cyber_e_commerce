      ...
      <div className="w-full bg-gray-200 mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="relative bg-white flex items-center p-6 rounded-lg shadow-md overflow-hidden">
            ...
            />
            {/* Text Content */}
            <div className="flex  flex-start flex-col gap-2 ml-6">
              <p className=" w-52  text-black font-semibold font text-[30px]">
                PlayStation 5
              </p>
        ...
        {/* Right Side */}
        <div className="bg-white flex flex-col md:flex-row items-center justify-between p-6 rounded-lg shadow-md relative">
          <div className="flex flex-col  p-6 gap-6 items-start">
            {" "}
            <p className=" realtive -right-80 font-extralight text-[50px]">
              MacBook
            </p>
            <p>Buy The new powerful MackBook </p>
          </div>
          <img
            src={lap}
            alt="Laptop"
            className="w-[353px] h-[549px] object-contain  relative left-[0px] z-[]"
          />
        </div>
      </div>
    </div>
