...
<div className="w-full bg-gray-200 mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 p-6">
  ...
  <div className="flex flex-col gap-4">
    {/* Top Half */}
    <div className="bg-white flex items-center justify-between p-6 rounded-lg shadow-md">
      <img
        src={ps5}
        alt="PS5"
      ...
      <div className="flex flex-col gap-4 flex-grow">
        <p className="border border-gray-400 rounded-md w-40 p-2 text-black text-10xl md:text-2xl">
          Play Station
        </p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {/* Bottom Left Box */}
      <div className="bg-gray-200 flex items-center justify-between p-6 rounded-lg shadow-md">
        <img
          src={airpods}
          alt="AirPods"
          className="w-28 md:w-[243px] h-auto object-contain"
        />
        <p className="text-black text-xl md:text-2xl">AirPods Pro</p>
      </div>

      {/* Bottom Right Box */}
      <div className="bg-gray-600 flex items-center justify-between p-6 rounded-lg shadow-md">
        <img
          src={vision}
          alt="Vision Pro"
          className="w-28 md:w-[312px] h-auto object-contain"
        />
        <p className="text-white text-xl md:text-2xl">Vision Pro</p>
      </div>
    </div>
  </div>
</div>
