        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="relative bg-white flex items-center p-6 rounded-lg shadow-md overflow-hidden">
            ...
            <div className="flex flex-col gap-2 ml-6">
              <p className=" w-40 p-2 text-black text-xl md:text-2xl font-semibold">
                PlayStation 5
              </p>
              ...
              {/* Button */}
              <button className="mt-2 px-4 py-2 border border-gray-400 text-white rounded-lg shadow hover:bg-blue-700 transition">
                Buy Now
              </button>
            </div>
          </div>
