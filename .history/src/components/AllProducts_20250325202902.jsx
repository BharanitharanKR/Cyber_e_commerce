...
const NavbarTop = () => {
  ...
  return (
    <div className="flex mt-16 items-center justify-between px-10 py-3 bg-gray-100 shadow">
      {/* Dropdown Button */}
      <div className="relative">
        <button
          onClick={() => setIsOpen(!isOpen)}
          className="flex items-center gap-2 px-4 py-2 bg-white border rounded-md shadow-md hover:bg-gray-200"
        >
