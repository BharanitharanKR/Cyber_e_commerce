    ...
    <div className="flex flex-col items-center w-full">
      ...
      <div className="bg-red-700 w-full flex justify-center items-center py-20 px-8">
        <div className="max-w-2xl text-center text-white">
          ...
          <div className="flex items-center border-2 border-white rounded-md overflow-hidden w-[400px] mx-auto">
            <input
              type="text"
      ...
      <div className="bg-black w-full flex justify-center py-20 px-8">
        <div className="max-w-[1400px] text-white grid grid-cols-4 gap-14">
          ...
          <div className="flex flex-col items-start">
            <img src={Cyber_logo} className="mb-6 w-32" />
            <h2 className="text-xl font-semibold mb-3">Subscribe</h2>
            <p className="text-gray-200 mb-5">Get 10% off your first order</p>
            <input
              type="text"
              placeholder="Enter your email"
              className="border border-gray-500 rounded p-3 w-full text-black"
            />
          </div>
