...
import { ExpandLess, ExpandMore, AttachMoney, Business, Category, Star, CheckCircle } from "@mui/icons-material";
    ...
    >
      <List>
        ...
        <ListItemButton onClick={() => handleExpand("price")} sx={{ mb: 1 }}>
          <AttachMoney sx={{ mr: 1 }} />
          <ListItemText primary={<Typography fontWeight="bold">Price</Typography>} />
        ...
        <ListItemButton onClick={() => handleExpand("brand")} sx={{ mb: 1 }}>
          <Business sx={{ mr: 1 }} />
          <ListItemText primary={<Typography fontWeight="bold">Brand</Typography>} />
          ...
          <Box sx={{ px: 3, py: 2 }}>
            ...
            <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
              {Object.keys(brands).map((brand) => (
                <FormControlLabel
                  key={brand}
                  control={<Checkbox checked={brands[brand]} onChange={handleBrandChange} name={brand} />}
                  label={brand}
                />
              ))}
            </Box>
