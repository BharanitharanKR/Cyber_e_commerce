...
const Footer = () => {
  return (
    <div>
      {/* Subscribe Section */}
      <div className="bg-red-700 h-[300px] w-screen flex justify-center items-center py-10 px-4">
      ...
      {/* Footer Section */}
      <div className="w-screen bg-black flex justify-center ml-[700px] items-center py-10">
