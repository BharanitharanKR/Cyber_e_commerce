...
import submain from "../assets/submain
const ProductPage = () => {
  // Array of images for the carousel
  const images = ["assets/submain.png"];
    ...
    <div className="container mx-auto p-6 flex gap-6">
      ...
      <div className="w-1/2 flex flex-col items-center">
        ...
        <div className="relative w-full">
          ...
          <button
            onClick={prevImage}
            className="absolute left-2 top-1/2 transform -translate-y-1/2 p-3 bg-gray-800 text-white rounded-full"
          >
            ←
          </button>
          <button
            onClick={nextImage}
            className="absolute right-2 top-1/2 transform -translate-y-1/2 p-3 bg-gray-800 text-white rounded-full"
          >
            →
          </button>
        </div>
