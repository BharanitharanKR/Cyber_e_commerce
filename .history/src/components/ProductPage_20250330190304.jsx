  ...
  return (
    <div className="container mx-auto pl-16 pr-16 flex gap-6">
      ...
      <div className="w-1/2 flex flex-col items-center">
        <img src={currentImage} alt="Product" className="w-full object-contain" />
      ...
      <div className="w-1/2 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between w-1/2">
          <p>Category: <span className="text-black font-bold">Electronics Devices</span></p>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="bg-yellow-500 text-white px-2 py-1 rounded">21% OFF</span>
        </div>

        {/* Options (Color, Size, Storage, Memory) */}
        <div className="grid items-center gap-2 mt-4 grid-cols-2 gap-6">
