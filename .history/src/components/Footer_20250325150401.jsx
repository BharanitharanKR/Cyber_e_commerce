  ...
  return (
    <div>
      <div className="bg-red-700 w-screen h-[360px] justify-center text-center">
        ...
        <div className="flex items-center border-2 border-gray-400 rounded-md overflow-hidden w-80">
          <input
            type="text"
            placeholder="Enter text here..."
            className="p-2 flex-1 outline-none"
          />
          <button className="bg-red-700 text-white px-4 py-2 hover:bg-white hover:border-2 border-black hover:text-black">
            Submit
          </button>
        </div>
      </div>
