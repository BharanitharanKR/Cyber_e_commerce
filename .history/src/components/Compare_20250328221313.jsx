      ...
      {tracking ? (
        <div className="w-[700px] mx-36 mt-38">
          ...
          <p className="w-[700px] text-lg leading-relaxed">
            Your order has been successfully tracked. It is currently in
            transit.
          </p>
          <Link
            to="/"
            className="mt-5 inline-block bg-blue-500 text-white py-3 px-6 rounded-lg font-medium hover:bg-blue-600 transition text-lg"
          >
            Go to Home
          </Link>
        </div>
