...
const Footer = () => {
  return (
    <div>
      <div className="bg-red-700 w-screen h-[360px] justify-center text-center">
        <h1>Subscribe to our newsletter</h1>
        <p>
          Praesent fringilla erat a lacinia egestas. Donec vehicula tempor
          libero et cursus. Donec non quam urna. Quisque vitae porta ipsum.
        </p>
        <div className="flex items-center border-2 border-white rounded-md overflow-hidden w-80 justify-center items-center">
          <input
            type="text"
            placeholder="Enter text here..."
            className="p-2 flex-1 outline-none"
          />
          <button className="bg-red-700 text-white px-4 py-2 hover:bg-white hover:border-2 border-red hover:text-black">
            Submit
          </button>
        </div>
      </div>
