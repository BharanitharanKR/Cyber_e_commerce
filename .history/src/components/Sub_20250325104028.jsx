    ...
    <div className="container mx-auto p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div className="row-span-2 bg-gray-100 p-6 rounded-lg flex flex-col items-center justify-between relative h-full">
          <div className="w-full h-[70%] border border-g flex items-center justify-center">
            <img
              src={products[0].img}
              alt={products[0].title}
              className="w-full h-full object-cover transition-transform duration-300  border border-gray-800 rounded hover:scale-105"
            />
          </div>
