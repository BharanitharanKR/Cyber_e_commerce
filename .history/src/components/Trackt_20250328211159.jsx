...
const Trackt = () => {
  return (
    <div className="container mt-28">
      ...
      <LINK to="/Tracked">
        <button className="w-[200px] mx-36 m-5 bg-red-500 text-white py-2 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-red-600 transition">
          TRACK ORDER →
        </button>
      </LINK>
    </div>
