...
const Footer = () => {
  return (
    <div className="w-screen bg-black flex justify-center items-center py-10">
      <div className="bg-white w-[1600px] text-white p-10 grid grid-cols-4 gap-10">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-gray-600">123, GCT College Coimbatore</p>
          <p className="text-gray-600">GoPay@gmail.com</p>
