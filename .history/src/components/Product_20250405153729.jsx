...
const Product = ({
  ...
  return (
    <div className="w-full sm:w-[234px] h-[300px] border rounded-lg shadow-md bg-white relative p-3 group">
      ...
      {/* Product Title */}
      <h3 className="mt-1 text-xs font-medium text-gray-800 truncate pt-2">
        {name}
      </h3>

      {/* Product Price */}
      <p className="text-red-600 font-bold mt-1 text-sm pt-2">${price}</p>
    </div>
  );
};
    ...
    <div className="flex text-yellow-500">
      ...
      {halfStar && (
        <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
          <path d="M12 .587l3.668 7.431 4.166 0.604-3 2.924 0.708 4.138L12 14.448V.587z" />
        </svg>
      )}
    </div>
  );
